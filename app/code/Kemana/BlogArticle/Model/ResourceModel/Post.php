...
class Post extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->postTagTable = $this->getTable('kemana_blog_post_tag');
        $this->postTopicTable = $this->getTable('kemana_blog_post_topic');
        $this->postCategoryTable = $this->getTable('kemana_blog_post_category');
        $this->postProductTable = $this->getTable('kemana_blog_post_product');
        $this->postTrafficTable = $this->getTable('kemana_blog_post_traffic');
    }
    ...
    {
        $this->_init('kemana_blog_post', 'post_id');
    }
    ...
    /**
     * @param \Kemana\Blog\Model\Post $post
     *
     * @return $this
     * @throws LocalizedException
     */
    public function saveTagRelation(\Kemana\Blog\Model\Post $post)
    {
     ...
     * @throws LocalizedException
     */
    public function saveTopicRelation(\Kemana\Blog\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'kemana_blog_post_change_topics',
     ...
     * @throws LocalizedException
     */
    public function saveCategoryRelation(\Kemana\Blog\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'kemana_blog_post_change_categories',
     ...
     * @return array
     */
    public function getCategoryIds(\Kemana\Blog\Model\Post $post)
    {
        $adapter = $this->getConnection();
     ...
     * @return array
     */
    public function getTagIds(\Kemana\Blog\Model\Post $post)
    {
        $adapter = $this->getConnection();
        $select = $adapter->select()->from(
            $this->postTagTable,
     ...
     * @return array
     */
    public function getTopicIds(\Kemana\Blog\Model\Post $post)
    {
        $adapter = $this->getConnection();
     ...
     * @return array
     */
    public function getViewTraffic(\Kemana\Blog\Model\Post $post)
    {
        $adapter = $this->getConnection();
     ...
     * @return $this
     */
    public function saveProductRelation(\Kemana\Blog\Model\Post $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'kemana_blog_post_change_products',
     ...
     * @return array
     */
    public function getProductsPosition(\Kemana\Blog\Model\Post $post)
    {
    ...
    public function saveAuthor()
    {
        ...
        if ($currentUser) {
            ...
            /** @var \Kemana\Blog\Model\Author $author */
