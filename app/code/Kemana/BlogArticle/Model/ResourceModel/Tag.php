...
class Tag extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->tagPostTable = $this->getTable('kemana_blog_post_tag');
    }
    ...
    {
        $this->_init('kemana_blog_tag', 'tag_id');
    }
    ...
    /**
     * @param \Kemana\Blog\Model\Tag $tag
     *
     * @return array
     */
    public function getPostsPosition(\Kemana\Blog\Model\Tag $tag)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Kemana\Blog\Model\Tag $tag)
    {
