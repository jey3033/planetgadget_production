...
class Topic extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->topicPostTable = $this->getTable('kemana_blog_post_topic');
    }
    ...
    {
        $this->_init('kemana_blog_topic', 'topic_id');
    }
    ...
    /**
     * @param \Kemana\Blog\Model\Topic $topic
     *
     * @return array
     */
    public function getPostsPosition(\Kemana\Blog\Model\Topic $topic)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Kemana\Blog\Model\Topic $topic)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'kemana_blog_topic_change_posts',
