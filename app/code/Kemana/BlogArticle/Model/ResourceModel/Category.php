...
class Category extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->categoryPostTable = $this->getTable('kemana_blog_post_category');
    }
    ...
    {
        $this->_init('kemana_blog_category', 'category_id');
    }
    ...
    protected function _beforeSave(AbstractModel $object)
    {
        ...
        /** @var \Kemana\Blog\Model\Category $object */
    ...
    protected function getMaxPosition($path)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('kemana_blog_category'),
            'MAX(' . $positionField . ')'
        )->where(
    ...
    /**
     * @param \Kemana\Blog\Model\Category $category
     * @param \Kemana\Blog\Model\Category $newParent
    ...
    public function changeParent(
        \Kemana\Blog\Model\Category $category,
        \Kemana\Blog\Model\Category $newParent,
     ...
     * @return array
     */
    public function getPostsPosition(\Kemana\Blog\Model\Category $category)
    {
        $select = $this->getConnection()->select()->from(
     ...
     * @return $this
     */
    public function savePostRelation(\Kemana\Blog\Model\Category $category)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'kemana_blog_category_change_posts',
