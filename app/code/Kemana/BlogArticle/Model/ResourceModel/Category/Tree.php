...
use Kemana\Blog\Model\ResourceModel\Category;
use Zend_Db_Select;
...
class Tree extends Dbp
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('kemana_blog_write'),
            $coreResource->getTableName('kemana_blog_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('kemana_blog_category_tree_init_inactive_category_ids', ['tree' => $this]);
    ...
    {
        $this->cache->clean([\Kemana\Blog\Model\Category::CACHE_TAG]);
