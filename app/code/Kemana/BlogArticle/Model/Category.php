...
class Category extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'kemana_blog_category';
     ...
     * @var string
     */
    protected $_cacheTag = 'kemana_blog_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'kemana_blog_category';
    ...
    public function getSelectedPostsCollection()
    {
        if (!$this->postCollection) {
            ...
            $collection->join(
                ['cat' => $this->getResource()->getTable('kemana_blog_post_category')],
