...
use Kemana\Blog\Block\Adminhtml\Renderer\Image;
use Kemana\Blog\Helper\Data;
use Kemana\Blog\Helper\Image as ImageHelper;
use Kemana\Blog\Model\Config\Source\AuthorStatus;

/**
 * Class Author
 * @package Kemana\Blog\Block\Adminhtml\Author\Edit\Tab
 */
class Author extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $author = $this->_coreRegistry->registry('kemana_blog_author');
    ...
    {
        return $this->getUrl('kemana_blog/author/customergrid');
    }
}
