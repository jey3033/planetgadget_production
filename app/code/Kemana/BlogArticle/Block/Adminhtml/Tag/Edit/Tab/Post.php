...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('kemana_blog_post_tag')],
    ...
    /**
     * @return \Kemana\Blog\Model\Tag
     */
    public function getTag()
    {
        return $this->coreRegistry->registry('kemana_blog_tag');
    }
    ...
    {
        return $this->getUrl('kemana_blog/tag/posts', ['_current' => true]);
    }
