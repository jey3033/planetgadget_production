...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('kemana_blog_post_topic')],
    ...
    /**
     * @return \Kemana\Blog\Model\Topic
     */
    public function getTopic()
    {
        return $this->coreRegistry->registry('kemana_blog_topic');
    }
    ...
    {
        return $this->getUrl('kemana_blog/topic/posts', ['_current' => true]);
    }
