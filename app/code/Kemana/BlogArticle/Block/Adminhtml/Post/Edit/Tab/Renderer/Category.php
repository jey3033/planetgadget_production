...
use Kemana\Blog\Model\ResourceModel\Category\CollectionFactory as BlogCategoryCollectionFactory;
...
class Category extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Kemana_Blog::category');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                ['handle' => 'kemana_blog_category_create', 'buttons' => 1]
            ) . '",
                                        "autoRender": false,
