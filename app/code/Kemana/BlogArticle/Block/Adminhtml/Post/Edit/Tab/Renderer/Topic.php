...
use Kemana\Blog\Model\ResourceModel\Topic\CollectionFactory as BlogTopicCollectionFactory;
...
class Topic extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Kemana_Blog::topic');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                [
                    'handle' => 'kemana_blog_topic_create',
                    'buttons' => 1
                ]
            ) . '",
                                        "autoRender": false,
