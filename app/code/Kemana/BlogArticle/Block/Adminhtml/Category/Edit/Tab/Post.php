...
namespace Kemana\Blog\Block\Adminhtml\Category\Edit\Tab;
...
/**
 * Class Post
 * @package Kemana\Blog\Block\Adminhtml\Category\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('kemana_blog_post_category')],
    ...
    /**
     * @return \Kemana\Blog\Model\Category
     */
    ...
    {
        return $this->getUrl('kemana_blog/category/posts', ['_current' => true]);
    }
