...
use Kemana\Blog\Model\CategoryFactory as BlogCategoryFactory;
use Kemana\Blog\Model\ResourceModel\Category\Tree as BlogResourceTree;
...
class Form extends AbstractCategory
{
    ...
    protected function _prepareLayout()
    {
        ...
        // Reset button
        $resetPath = $categoryId ? 'kemana_blog/*/edit' : 'kemana_blog/*/add';
    ...
    {
        /** @var \Kemana\Blog\Model\Category $category */
        ...
        return $this->getUrl('kemana_blog/*/save', $params);
    }
    ...
    {
        return $this->getUrl('kemana_blog/category/edit', ['_query' => false, 'id' => null, 'parent' => null]);
    }
    ...
    public function getDeleteUrl(array $args = [])
    {
        ...
        return $this->getUrl('kemana_blog/*/delete', $params);
    }
    ...
    public function getRefreshPathUrl(array $args = [])
    {
        ...
        return $this->getUrl('kemana_blog/*/refreshPath', $params);
    }
