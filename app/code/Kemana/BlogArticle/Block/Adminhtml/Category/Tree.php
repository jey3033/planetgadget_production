...
use Kemana\Blog\Model\ResourceModel\Category\Tree as BlogTreeResource;
...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
    ...
    {
        return $this->getUrl('kemana_blog/category/jsonTree');
    }
    ...
    {
        return $this->getUrl('kemana_blog/category/move');
    }
