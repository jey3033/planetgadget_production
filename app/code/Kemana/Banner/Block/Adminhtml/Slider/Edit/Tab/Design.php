...
use Kemana\Banner\Block\Adminhtml\Slider\Edit\Tab\Renderer\Responsive;
use Kemana\Banner\Model\Config\Source\Effect;
...
class Design extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $center = $fieldset->addField('center', 'select', [
            'name'   => 'center',
            'label'  => __('Is Center Banner'),
            'title'  => __('Is Center Banner'),
            'values' => $this->_yesno->toOptionArray()
        ]);
        ...
        $dependencies = $this->getLayout()->createBlock(Dependence::class)
            ...
            ->addFieldMap($center->getHtmlId(), $center->getName())
