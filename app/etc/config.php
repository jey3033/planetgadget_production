...
return [
    'modules' => [
        ...
        'Kemana_Smtp' => 1,
        'Kemana_Snap' => 1,
        'Kemana_SnapPayment' => 1,
        'Kemana_SocialLogin' => 1,
        'Kemana_SocialShare' => 1,
        'Kemana_SourceDistanceShipping' => 1,
        'Kemana_StockAvailabilityPopup' => 1,
        'Kemana_Storelocator' => 1,
        'Kemana_TopCategories' => 1,
        'Kemana_WhatsAppChat' => 1,
        'Klarna_Core' => 1,
